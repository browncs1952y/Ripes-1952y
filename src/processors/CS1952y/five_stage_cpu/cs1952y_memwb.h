...
class CS1952yMemWB : public Component {
public:
  CS1952yMemWB(const std::string &name, SimComponent *parent)
    ...
    CONNECT_REGISTERED_CLEN_INPUT(mem_res, clear, enable); // Mem -> WB
  ...
  REGISTERED_CLEN_INPUT(mem_res, XLEN);
