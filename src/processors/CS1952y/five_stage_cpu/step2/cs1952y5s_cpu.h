...
public:
  ...
  CS1952y5sCPU(const QStringList &extensions)
    ...
    idex_reg->reg1_out >> pc_add1->get(PCAdd1::RS);
    ...
    idex_reg->reg2_out >> exmem_reg->reg2_in;
